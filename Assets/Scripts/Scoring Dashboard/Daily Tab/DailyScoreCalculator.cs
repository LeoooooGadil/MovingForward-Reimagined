...
public static class DailyScoreCalculator
{
    ...
    public static void PublishDailyChore(string key, ChoresAggregate dailyChoreAggregate)
    {
        ...
        if (dateTime.Day == DateTime.Now.Day)
        {
            dailyScoreSave.dailyScore += dailyChoreAggregate.points;
            dailyScoreSave.keys.Add(key);
            DailyScoreStorage.Publish(key, dailyChoreAggregate.taskName, dailyChoreAggregate.points, dailyChoreAggregate.timestamp, DailyScoreStorageType.AutoGeneratedDailyChore);
